...
class PACKET {
  public:
    ...
    uint32_t cpu, data_index, lq_index, sq_index,acc_type;//added by me
	...
	fill_l1d = 0;
        ...
        s = 0;
        w = 0;
        read_write = 0;// assuming read(default)//venkat
        in_sram = false;
        in_stt = false;
...
class LSQ_ENTRY {
  public:
    ...
    uint32_t rob_index, data_index, sq_index,acc_type;//added by me
